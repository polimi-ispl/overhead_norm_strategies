...
(trap 'kill 0' SIGINT;
python ../test_with_AUCs.py --gpu $DEVICE --fe_path ../models/MinPMax_99_mean-scaling_False/model_weights.h5 \
...
python ../test_with_AUCs.py --gpu $DEVICE --fe_path ../models/MinPMax_95_mean-scaling_False/model_weights.h5 \
--root_dir $SGD_DIR --results_dir $RESULTS_DIR --preprocessing_dir $PREPROCESSING_DIR & \
python ../test_with_AUCs.py --gpu $DEVICE --fe_path ../models/MinPMax_95_mean-scaling_False/model_weights.h5 \
--root_dir $HEGD_DIR --results_dir $RESULTS_DIR --preprocessing_dir $PREPROCESSING_DIR & \
